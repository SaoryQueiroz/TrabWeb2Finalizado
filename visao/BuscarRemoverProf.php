                ...
                <?php
                    try {
                        ...
                        if($resultado->rowCount() > 0) {
                            ...
                            echo "<caption>Lista de professores cadastrados</caption>";
                            ...
                            while($row = $resultado->fetch()) {
                                ...
                                echo "<td><a class='btn btn-primary' href='EditarProfessor.php?id=".$row['id']."' role='button'>Editar</a> </td>";
                                echo "<td>
                                <a class='btn btn-danger' href='../repositorio/RemoverProf.php?id=".$row['id']."' role='button'>Remover</a>
                                </td>";
                                echo "</tr>";
                            }
                            echo "</table>";
