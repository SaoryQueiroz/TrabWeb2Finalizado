			...
			$(document).ready(function() {
				$('#salvarcomajax').click(function() {
					...
					$.ajax({
						type: 'POST',
						dataType: 'json',
						url: '../repositorio/SalvarAlunoComAjax.php',
						async: true,
						data: dados,
	...
	<body>
		<div class="container">
			...
			<div class="row" style="margin-top: 2%;">
				<h4>
                  Cadastre o aluno no sistema com suas
                  <small class="text-muted">informações pessoais</small>
                </h4>
				<div class="col-md-12">
					<form id="formcadastroaluno" name="form" action="../repositorio/SalvarAluno.php" method="POST">
						<div class="form-row">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-4">
								...
								<input id="raID" class="form-control" type="text" name="ra" required/>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-4"> 
								<label for="cursoID">Curso </label>
								<input id="cursoID" class="form-control" type="text" name="curso" required/>
							</div>
							<div class="form-group col-md-4">
