				...
				try {
					...
					if($resultado->rowCount() > 0) {
						...
						?>
							<div class="row" style="margin-top: 2%;">
								<div class="col-md-12">
									<form action="../repositorio/SalvarEdicaoProfessor.php" method="POST">
									<input value= "<?php echo $row['id'] ?>" class="form-control" type="hidden" name="id"/>
										...
										<div class="form-row">
											...
											<div class="form-group col-md-4">
												...
												<input value= "<?php echo $row['siape'] ?>" id="siapeID" class="form-control" type="text" name="siape" required/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-4">
										...
										<a class='btn btn-secondary' href='BuscarRemoverProf.php' role='button'>Voltar</a>
									</form>
								</div>
							</div>
						<?php
